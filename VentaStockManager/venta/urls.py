...
urlpatterns = [
    ...
    path('venta/api/clientes/<int:cliente_id>/asignarme/', api_cliente_asignarme, name='venta_api_cliente_asignarme'),
    path('venta/api/direcciones/geocodificar/', api_direccion_geocodificar, name='venta_api_direccion_geocodificar'),
    path('venta/api/clientes/<int:cliente_id>/saldo/', api_cliente_saldo, name='venta_api_cliente_saldo'),
    path('venta/api/clientes/<int:cliente_id>/horario/', api_cliente_horario, name='venta_api_cliente_horario'),
